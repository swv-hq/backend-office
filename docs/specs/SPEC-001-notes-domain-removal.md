...
- **SPEC-001.AC5** [web]: Notes components removed (Notes, NoteItem, NoteDetails, CreateNote, DeleteNote, Checkbox)
...
- The web marketing homepage (Hero, Benefits, Testimonials, Footer) is unrelated to notes and should be left in place for now.
